...
{
   public class HarrisViewModel : BaseViewModel
    {
        public event PropertyChangedEventHandler PropertyChanged;
        public AsyncCommand ShowInfoCommand { get; }
        public AsyncCommand HarrisResult { get; }
        public HarrisViewModel()
        {
            HarrisResult = new AsyncCommand(Harris);
        ...
        async Task Harris()
        {
            try
            {
                ...
                result = vm.Harris(height, mass, age,  sexValue);
                OnPropertyChanged(nameof(Result));
            }
            catch (Exception ex)
            {
